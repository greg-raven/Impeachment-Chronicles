...
Not one of the four FISA warrants obtained by the FBI was legally justified, according to [DOJ Inspector General Michael Horowitz’s report]({% post_url 2019-12-09-review-of-four-fisa-applications-and-other-aspects-of-the-fbis-crossfire-hurricane-investigation.md %}). In fact, at least two of the warrant applications to spy on Page were declared illegal by a federal judge. Following Horowitz’s blistering report outlining FBI misconduct throughout the entire operation, another federal judge declared that agency malfeasance “calls into question whether information contained in other FBI applications is reliable.”
